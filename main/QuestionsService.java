...
public class QuestionsService {
        ...
        public QuestionsService() {
                ...
                questions[5] = new Question(6, "How do you create a variable with the floating number 2.8?",
                                "float x= 2.8f;",
                ...
                questions[8] = new Question(9, "What is the correct way to create an object called myObj of MyClass?",
                                ...
                                "class MyClass = new myobj();", "MyClass myOb =new MyClass();",
                                "new myObj = MyClass();",
                                "new myObj = MyClass();");
        ...
        public void printScore() {
                ...
                for (int i = 0; i < questions.length; i++) {
                        ...
                        if (actualAnswer.equals(userAnswer)) {
                                ...
                                System.out.println("Question " + (i + 1) + ": Incorrect. The correct answer is: "
                                                + actualAnswer);
                        }
                }
